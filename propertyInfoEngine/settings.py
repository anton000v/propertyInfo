"""
Django settings for propertyInfoEngine project.
...
WSGI_APPLICATION = 'propertyInfoEngine.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'propertyInfo/static')
